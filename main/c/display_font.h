...
static inline const uint8_t *tinyblok_oled_glyph(char ch)
{
    ...
    static const uint8_t glyph_j[TINYBLOK_OLED_GLYPH_WIDTH] = {0x20, 0x40, 0x44, 0x3D, 0x00};
    ...
    static const uint8_t glyph_m[TINYBLOK_OLED_GLYPH_WIDTH] = {0x7C, 0x04, 0x18, 0x04, 0x78};
    ...
    static const uint8_t glyph_q[TINYBLOK_OLED_GLYPH_WIDTH] = {0x08, 0x14, 0x14, 0x18, 0x7C};
    ...
    static const uint8_t glyph_u[TINYBLOK_OLED_GLYPH_WIDTH] = {0x3C, 0x40, 0x40, 0x20, 0x7C};
    static const uint8_t glyph_v[TINYBLOK_OLED_GLYPH_WIDTH] = {0x1C, 0x20, 0x40, 0x20, 0x1C};
    static const uint8_t glyph_w[TINYBLOK_OLED_GLYPH_WIDTH] = {0x3C, 0x40, 0x30, 0x40, 0x3C};
    static const uint8_t glyph_x[TINYBLOK_OLED_GLYPH_WIDTH] = {0x44, 0x28, 0x10, 0x28, 0x44};
    static const uint8_t glyph_y[TINYBLOK_OLED_GLYPH_WIDTH] = {0x0C, 0x50, 0x50, 0x50, 0x3C};
    static const uint8_t glyph_z[TINYBLOK_OLED_GLYPH_WIDTH] = {0x44, 0x64, 0x54, 0x4C, 0x44};
    ...
    static const uint8_t glyph_D[TINYBLOK_OLED_GLYPH_WIDTH] = {0x7F, 0x41, 0x41, 0x22, 0x1C};
    static const uint8_t glyph_E[TINYBLOK_OLED_GLYPH_WIDTH] = {0x7F, 0x49, 0x49, 0x49, 0x41};
    static const uint8_t glyph_F[TINYBLOK_OLED_GLYPH_WIDTH] = {0x7F, 0x09, 0x09, 0x09, 0x01};
    static const uint8_t glyph_G[TINYBLOK_OLED_GLYPH_WIDTH] = {0x3E, 0x41, 0x49, 0x49, 0x7A};
    ...
    static const uint8_t glyph_J[TINYBLOK_OLED_GLYPH_WIDTH] = {0x20, 0x40, 0x41, 0x3F, 0x01};
    ...
    static const uint8_t glyph_M[TINYBLOK_OLED_GLYPH_WIDTH] = {0x7F, 0x02, 0x0C, 0x02, 0x7F};
    ...
    static const uint8_t glyph_Q[TINYBLOK_OLED_GLYPH_WIDTH] = {0x3E, 0x41, 0x51, 0x21, 0x5E};
    static const uint8_t glyph_R[TINYBLOK_OLED_GLYPH_WIDTH] = {0x7F, 0x09, 0x19, 0x29, 0x46};
    ...
    static const uint8_t glyph_V[TINYBLOK_OLED_GLYPH_WIDTH] = {0x1F, 0x20, 0x40, 0x20, 0x1F};
    static const uint8_t glyph_W[TINYBLOK_OLED_GLYPH_WIDTH] = {0x7F, 0x20, 0x18, 0x20, 0x7F};
    static const uint8_t glyph_X[TINYBLOK_OLED_GLYPH_WIDTH] = {0x63, 0x14, 0x08, 0x14, 0x63};
    static const uint8_t glyph_Y[TINYBLOK_OLED_GLYPH_WIDTH] = {0x07, 0x08, 0x70, 0x08, 0x07};
    static const uint8_t glyph_Z[TINYBLOK_OLED_GLYPH_WIDTH] = {0x61, 0x51, 0x49, 0x45, 0x43};
